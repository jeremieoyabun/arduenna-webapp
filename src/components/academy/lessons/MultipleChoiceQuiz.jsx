...
export const MultipleChoiceQuiz = ({ lesson, stepIndex, onNext, lang = "fr" }) => {
  ...
  const getOptionStyle = (i) => {
    ...
    if (i === lesson.correctIndex) {
      return { ...base, background: "rgba(74,155,138,0.15)", border: "1.5px solid #4a9b8a", color: "#6ec9a8" };
    }
    if (i === selected) {
      return { ...base, background: "rgba(194,116,74,0.15)", border: "1.5px solid #c2744a", color: "#e0a070", animation: "shake-wrong 0.2s ease-out" };
    }
