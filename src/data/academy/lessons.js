  ...
  // Leçon 1, Swipe (5 cards)
  {
    ...
    cards: [
      ...
      },
      {
        ...
        img: "/Arduenna_Bouteille_50CL-V2.avif", imgContain: true,
      },
    ],
  },
  // Leçon 2, 4 QCM
...
const univers4 = [
    ...
    cards: [
      {
        ...
        textEn: "The B Corp certification assesses a company's overall impact on 5 pillars: Governance, Employees, Community, Environment and Customers. Arduenna is among the most responsible companies.",
      },
      {
        ...
        textEn: "All Arduenna's ingredients are from organic farming (EU Organic certified). Zero pesticides, zero chemical additives. Nature respected at every step.",
      },
      {
        ...
        textEn: "The Arduenna bottle is made from 100% recyclable glass. Every detail of the packaging is designed to reduce environmental impact without compromising on premium.",
        img: "/Arduenna_Bouteille_50CL-V2.avif", imgContain: true,
      },
    ],
  },
  ...
  },
  {
    ...
    questionEn: "What makes the Arduenna bottle eco-responsible?",
