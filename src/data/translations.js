...
export const translations = {
  fr: {
    ...
    story: {
      ...
      title: "L'héritage d'une région",
      p1: "Arduenna est fièrement produit par la plus ancienne distillerie de Belgique. Cette collaboration nous permet de garantir des produits 100 % bio, en accord avec nos valeurs d'authenticité et de respect de la nature.",
      p2: "Chaque bouteille d'Arduenna reflète cet héritage, allié à notre désir d'innover tout en honorant les traditions ancestrales.",
    ...
    academyPromo: {
      ...
      title: "Arduenna Academy",
      subtitle: "Micro-learning interactif pour bartenders, commerciaux et cavistes. Maîtrisez l'univers Arduenna à votre rythme.",
      feat1: "Parcours interactifs", feat1Desc: "Quiz, flashcards, scénarios et swipe cards — 4 parcours pour tout savoir sur Arduenna.",
      feat2: "Gamification", feat2Desc: "Gagnez des XP, maintenez votre streak, débloquez des badges et grimpez au classement.",
      feat3: "Certificats", feat3Desc: "Obtenez des attestations officielles à partager sur vos réseaux professionnels.",
      cta: "Accéder à l'Academy",
    },
    teasers: {
  ...
  en: {
    ...
    story: {
      sectionLabel: "Our story", title: "The heritage of a region",
      p1: "Arduenna is proudly produced by Belgium's oldest distillery. This collaboration allows us to guarantee 100% organic products, in line with our values of authenticity and respect for nature.",
      p2: "Every bottle of Arduenna reflects this heritage, combined with our desire to innovate while honouring ancestral traditions.",
    ...
    academyPromo: { sectionLabel: "Academy", title: "Arduenna Academy", subtitle: "Interactive micro-learning for bartenders, sales reps and wine merchants. Master the Arduenna universe at your own pace.", feat1: "Interactive courses", feat1Desc: "Quizzes, flashcards, scenarios and swipe cards — 4 learning paths to master Arduenna.", feat2: "Gamification", feat2Desc: "Earn XP, maintain your streak, unlock badges and climb the leaderboard.", feat3: "Certificates", feat3Desc: "Earn official certificates to share on your professional networks.", cta: "Access the Academy" },
